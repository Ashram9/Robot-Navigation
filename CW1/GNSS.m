...
for epoch = 1:num_epochs
    ...
    while true
        ...
        % Outlier Detection
        % The initial position is usually an estimate, resulting in large residuals.
        % Skip the first epoch to avoid mistaking the initial estimated location for an outlier.
        if epoch > 1
            % Calculate residuals
