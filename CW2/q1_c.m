...
xlabel('x')
ylabel('y')
saveas(gcf,'Figures/q1_c_simulation.png')
...
hold on
saveas(gcf,'Figures/q1_c_Optimization_times.png');
...
saveas(gcf,'Figures/q1_c_Vehicle_Covariances.png');
...
hold on
saveas(gcf,'Figures/q1_c_chi2.png');
