...
xlabel('x');
ylabel('y');
saveas(gcf,'Figures/q3_b_simulation.png');
...
saveas(gcf,'Figures/q3_b_Optimization_times.png');
...
legend('x', 'y', 'phi')
title('Errors')
saveas(gcf,'Figures/q3_b_Errors.png');
...
saveas(gcf,'Figures/q3_b_Vehicle_Covariances.png');
...
hold on
saveas(gcf,'Figures/q3_b_chi2.png');
